 ...
 */
@WebServlet("/yusungguregister.do")
public class YuSungGuRegisterServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public YuSungGuRegisterServlet() {
		super();
...
//			      sVo.setStoreDate(storeDate);
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("YuSungGu.do");
		dispatcher.forward(request, response);
	}
