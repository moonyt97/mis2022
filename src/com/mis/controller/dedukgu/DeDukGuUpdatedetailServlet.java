 ...
 */
@WebServlet("/dedukguUpdatedetail.do")
public class DeDukGuUpdatedetailServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public DeDukGuUpdatedetailServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("dedukgu/detailUpdate.jsp");
