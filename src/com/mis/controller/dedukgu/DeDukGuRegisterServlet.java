 ...
 */
@WebServlet("/dedukguregister.do")
public class DeDukGuRegisterServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public DeDukGuRegisterServlet() {
		super();
...
//			      sVo.setStoreDate(storeDate);
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("DeDukGu.do");
		dispatcher.forward(request, response);
	}
