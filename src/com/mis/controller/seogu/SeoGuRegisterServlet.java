 ...
 */
@WebServlet("/seoguregister.do")
public class SeoGuRegisterServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SeoGuRegisterServlet() {
        super();
...
//					      sVo.setStoreDate(storeDate);
				...
				RequestDispatcher dispatcher = request.getRequestDispatcher("SeoGu.do");
				dispatcher.forward(request, response);
			}
