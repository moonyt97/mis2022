 ...
 */
@WebServlet("/dongguregister.do")
public class DongGuRegisterServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public DongGuRegisterServlet() {
		super();
...
//					      sVo.setStoreDate(storeDate);
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("DongGu.do");
		dispatcher.forward(request, response);
	}
