...
<body>
	...
	<div
		...
		<h1 class="logo me-auto me-lg-0">
			<a href="index.jsp">Restaurantly</a>
		</h1>
				...
				<div class="col-lg-4 col-md-6" style="margin-top:20px">
					<div class="member" data-aos="zoom-in" data-aos-delay="100">
						...
						<div class="member-info">
							...
							<div class="social">
								<a href="donggustoreDetail.do?num=${store.storeNo}">상세페이지로
									이동</a>
							</div>
						</div>
					</div>
	...
	<div class="container">
		<div class="copyright">
			&copy; Copyright <strong><span>JMT</span></strong>. All Rights
			Reserved
		</div>
		<div class="credits">
			...
			Designed by <a href="https://bootstrapmade.com/">MIT</a>
		</div>
	</div>
	</footer>
	<!-- End Footer -->
