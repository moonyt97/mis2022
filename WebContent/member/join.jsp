	...
	<div class="container" data-aos="fade-up" align="center">
		...
		<div class="col-lg-8 mt-5 mt-lg-0">
			...
			<form action="Join.do" method="post" name="frm"
				...
				<div class="row">
					...
					<div class="form-group mt-3">
						<input type="text" oninput="handleOnInput(this)"
							...
							style="width: 300px; height: 40px;"> <input type="hidden"
							name="reid" size="20"> <input type="button" value="중복 체크"
							onclick="idCheck()" style="width: 300px; height: 40px;">
					</div>
				</div>
				<div class="form-group mt-3">
				...
				<div class="form-group mt-3">
					<input type="radio" name="memberAdmin" value="0" checked="checked">
					일반회원 <input type="radio" name="memberAdmin" value="1"> 사업자
				</div>
				<div class="my-3">
