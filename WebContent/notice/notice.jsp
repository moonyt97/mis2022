...
<body>
	...
	<main id="main"> <section id=Notice " class="Notice">
	<div class="container" data-aos="fade-up">
		<div class="section-title">
			...
			<div class="section-title-register">
				<p>공지사항</p>
				<c:choose>
					<c:when test="${loginUser.memberAdmin eq '2'}">
						<a href="noticeRegister.do">공지사항 등록</a>
					</c:when>
					<c:otherwise>
					<span></span>
					</c:otherwise>
				...
				<div class="col-lg-4 col-md-6">
					<div class="member" data-aos="zoom-in" data-aos-delay="100">
						...
						<div class="member-info">
							...
							<div class="social">
								<a href="noticeDetail.do?num=${notice.noticeNo}">상세페이지로 이동</a>
							</div>
						</div>
					</div>
				</div>
