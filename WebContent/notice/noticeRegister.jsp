			...
			<div class="col-lg-8 mt-5 mt-lg-0">
				...
				<form action="noticeRegister.do" method="post"
					...
					<div class="row">
						...
						<div class="col-md-6 form-group">
							<input type="text" name="memberId" class="form-control" id="name"
								readonly value="${loginUser.memberId}" required>
						</div>
						<div class="form-group mt-3">
							<input type="text" class="form-control" name="noticeTitle"
								id="email" placeholder="noticeTitle" required>
						</div>

					</div>
					<div class="form-group mt-3">
						<textarea class="form-control" name="noticeContent" rows="8"
							placeholder="noticeContent" required></textarea>
					</div>
					...
					<%-- 		<input type="text" name="noticeNo" class="form-control" id="name"
						...
						<div class="col-md-6 form-group">
							<!-- <input type="text" name="noticeNo" class="form-control" id="name" placeholder="noticeNo" required> -->
						</div>
						<div class="form-group mt-3">
							<input type="text" class="form-control" name="noticeTitle"
								id="email" placeholder="noticeTitle" required>
					...
					<div class="form-group mt-3">
						<input type="text" class="form-control" name="noticeContent"
							id="subject" placeholder="noticeContent" required>
					</div>
					<div class="form-group mt-3">
						<input type="text" class="form-control" name="memberId" rows="8"
