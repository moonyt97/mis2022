...
<body>
	...
	<div class="container" data-aos="fade-up">
		...
		<div class="col-lg-8 mt-5 mt-lg-0">
			...
			<form action="NoticeUpdateDetail.do" method="post"
				...
				<div class="row">
					<div class="col-md-6 form-group">
						<input type="hidden" name="noticeNo" class="form-control"
							id="name" value="${nVo.noticeNo}"> <input type="hidden"
							name="memberId" class="form-control" id="name"
							value="${nVo.memberId}">
					</div>

					<div class="col-md-6 form-group">
						<input type="text" class="form-control" id="name" readonly
							value="${nVo.memberId}" required>
					</div>

					<div class="form-group mt-3">
						<input type="text" class="form-control" name="noticeTitle"
							id="email" value="${nVo.noticeTitle}" required>
					</div>
				</div>
				<div class="form-group mt-3">
					<textarea class="form-control" name="noticeContent" rows="8"
						required>${nVo.noticeContent}</textarea>
				</div>
