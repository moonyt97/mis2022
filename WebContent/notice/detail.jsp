...
<body>
	...
	<div class="container" data-aos="fade-up">
		...
		<div class="col-lg-8 mt-5 mt-lg-0">
			...
			<form action="noticeDetail.do" method="post" class="php-email-form">
				<div class="row">

<%-- 					<div class="col-md-6 form-group">
						<input type="text" name="noticeNo" class="form-control" id="name"
							readonly value="${nVo.noticeNo}" required>
					</div> --%>

					<div class="col-md-6 form-group">
						<input type="text" name="memberId" class="form-control" id="name"
							readonly value="${nVo.memberId}" required>
					</div>

					<div class="form-group mt-3">
						<input type="text" class="form-control" name="noticeTitle"
							id="email" readonly value="${nVo.noticeTitle}" required>
					</div>

					<div class="form-group mt-3">
						<textarea class="form-control" name="noticeContent" rows="8"
							readonly>${nVo.noticeContent}</textarea>
					</div>


					<%-- <div class="col-md-6 form-group mt-3 mt-md-0">
						<input type="text" class="form-control" name="noticeTitle"
							id="email" value="${nVo.noticeTitle}" readonly required>
					</div>
				</div>
				<div class="form-group mt-3">
					<input type="text" class="form-control" name="noticeContent"
						id="subject" readonly value="${nVo.noticeContent}" required>
				</div>
				<div class="form-group mt-3">
					<textarea class="form-control" name="memberId" rows="8"
						placeholder="${nVo.memberId}" readonly required>${nVo.memberId}</textarea>
				</div> --%>
					...
					<div class="form-group mt-3">
						...
						<div style="display: flex">
							<c:choose>
								<c:when test="${nVo.memberId eq loginUser.memberId}">
									<div class="text-center">
										<input type="button" value="수정하기"
											onclick="location.href='NoticeUpdateDetail.do?num=${nVo.noticeNo}'"></input>
									</div>
								</c:when>
								<%-- 						<c:otherwise>
							<span></span>
								...
								<c:when test="${nVo.memberId eq loginUser.memberId}">
									<div class="text-center">
										<input type="button" value="삭제하기"
											onclick="location.href='NoticeDelete.do?noticeNo=${nVo.noticeNo}'"></input>
									</div>
								</c:when>
								<c:otherwise>
									<span></span>
