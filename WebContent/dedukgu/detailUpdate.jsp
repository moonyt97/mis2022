	...
	<div class="container" data-aos="fade-up" align="center">
		<div class="row mt-5">
			...
			<div class="col-lg-8 mt-5 mt-lg-0">
				...
				<form action="dedukguUpdatedetail.do" method="post"
					...
					<div class="col-lg-4">
                     ...
                     placeholder="storeImg" required> -->
									<div class="image-container">
										<img style="width: 415px; margin-right: 50px"
											id="preview-image" src="${sVo.storeImg}">
											 <input
											style="display: block; width: 415px; margin-right: 50px;"
											type="file" name="storeImg" class="form-control"
											id="input-image" placeholder="${sVo.storeImg}"
											value="${sVo.storeImg}" required>
									</div>
								</div>
							</div>
							<div>
								<div class="row">
									<div class="form-group mt-3">
										<input type="hidden" name="storeNo" class="form-control"
											id="name" readonly value="${sVo.storeNo}" required
											style="width: 300px; height: 40px;">
									</div>
									<div class="form-group mt-3">
										<input type="text" class="form-control" name="storeTitle"
											id="email" placeholder="${sVo.storeTitle}"
											value="${sVo.storeTitle}" required
											style="width: 300px; height: 40px;">
									</div>
								</div>
								<div class="form-group mt-3">
									<input type="text" class="form-control" name="storeLo" rows="8"
										placeholder="${sVo.storeLo}" readonly required
										style="width: 300px; height: 40px;">
								</div>

								<div class="form-group mt-3">
									<textarea class="form-control" name="storeContent" rows="8">${sVo.storeContent}</textarea>
								</div>
