	...
	<div class="container" data-aos="fade-up" align="center">
		<div class="row mt-5">
			...
			<div class="col-lg-8 mt-5 mt-lg-0">
				...
				<form action="jungguUpdatedetail.do" method="post"
                     ...
                     placeholder="storeImg" required> -->
									<div class="image-container" >
										<img style="width: 415px; margin-right:50px" id="preview-image"
											src="${sVo.storeImg}"> <input
											style="display: block;width:415px; margin-right:50px;" type="file" name="storeImg"
											class="form-control" id="input-image" required
											placeholder="${sVo.storeImg}" value="${sVo.storeImg}"
											>
									</div>
								</div>
							</div>
